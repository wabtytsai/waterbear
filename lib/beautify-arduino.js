...
---------------
  ...
  Modified Quickly by Martyn Eggleton
      https://github.com/stretchyboy/js-beautify
  ...
  Usage:
    arduino_beautify(js_source_text);
    arduino_beautify(js_source_text, options);
...
function arduino_beautify(js_source_text, options) {
...
// and you will be able to `var arduino_beautify = require("beautify").arduino_beautify`.
if (typeof exports !== "undefined")
    exports.arduino_beautify = arduino_beautify;
