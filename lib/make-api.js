...
(function(module) {
    ...
    function nodeStrategy(type, path, data, callback) {
        ...
        if (authObj) {
            ...
            header = hawk.client.header(path, type, {
        ...
        request(requestOptions, function(err, res, body) {
            ...
            if (credentials) {
                if (!hawk.client.authenticate(res, credentials, header.artifacts, {
    ...
    function wrap(make, options) {
        ...
        ["url", "contentType", "locale", "title",
            ...
            "updatedAt", "likes", "reports", "remixurl", "editurl"
    ...
    Make = function Make(options) {
        ...
        return {
            ...
            unlike: function update(id, maker, callback) {
                doXHR("PUT", API_PREFIX + "unlike/" + id, {
                    maker: maker
                }, callback);
                return this;
            },
            ...
            report: function report(id, maker, callback) {
                doXHR("PUT", API_PREFIX + "report/" + id, {
                    maker: maker
                }, callback);
                return this;
            },
            ...
            cancelReport: function cancelReport(id, maker, callback) {
                doXHR("PUT", API_PREFIX + "cancelReport/" + id, {
                    maker: maker
                }, callback);
                return this;
            },
